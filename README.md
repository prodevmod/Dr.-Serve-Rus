...
Coming from different backgrounds we had different skills,yet though our collaboration we gained insights on eaoch others skills while improoving the ones we had.

# How It Works
* A rotating circular plate is divided into four sections.
...
* Reduce distractions for surgical assistants.
* Improve organization during procedures.
* Help track important surgery information through an OLED display.

# What is the future holding?
As this project is still an MVP and a prototype, not every idea of ours is expressed the way we wanted. The main adjustments we want to do are: 
* Replace the DC motor with a 360 step motor. (removing thus the rotary encoder)
...
Copyright © 2026 Dr. Serve-Rus Development Team

All Rights Reserved.

Dr. Serve-Rus, including but not limited to its source code, firmware, hardware designs, circuit schematics, documentation, images, presentations, reports, research materials, and associated files, is the intellectual property of its creators.

This project is published for demonstration and informational purposes only.

Without prior written permission from the authors, no individual or organization may:

* Copy or reproduce any part of this project.
* Modify or create derivative works based on this project.
* Redistribute, re-upload, or republish project materials.
* Use the project or its components in academic submissions, competitions, commercial products, or other public works.
* Claim ownership or authorship of any portion of the project.

Viewing and studying the project is permitted; however, all rights remain with the authors.

For licensing inquiries or permission requests, please contact the project team through the email address: rosandrox12@gmail.com.
